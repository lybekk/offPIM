            ...
            v-card-text
                v-container
                    v-row(dense='')
                        ...
                        v-col(cols='12')
                            v-textarea(v-model='newEntry.description', label='Details/Description', rows='3', filled='', dense='')
                        v-col(cols='12')
                            v-combobox(v-model='newEntry.tags', :items='tagsListItems', label='Tags', multiple='', chips='', dense='')
                        v-col(cols='12', sm='6', md='4')
                            v-menu(v-model='startDateModal', :close-on-content-click='false', :nudge-right='40', transition='scale-transition', offset-y='', min-width='290px')
                                template(v-slot:activator='{ on }')
                                    v-text-field(v-model='pickerStartDate', label='Start date', prepend-icon='mdi-calendar', readonly='', v-on='on')
                        ...
                        v-col(cols='11', sm='5')
                            v-menu(ref='starttimemodal', v-model='startTimeModal', :close-on-content-click='false', :nudge-right='40', :return-value.sync='pickerStartTime', transition='scale-transition', offset-y='', max-width='290px', min-width='290px')
                                template(v-slot:activator='{ on }')
                                    v-text-field(v-model='pickerStartTime', label='Due time', prepend-icon='mdi-clock', readonly='', v-on='on')
                        ...
                        v-col(cols='12', sm='6', md='4')
                            v-menu(v-model='endDateModal', :close-on-content-click='false', :nudge-right='40', transition='scale-transition', offset-y='', min-width='290px')
                                template(v-slot:activator='{ on }')
                                    v-text-field(v-model='pickerEndDate', label='End date', prepend-icon='mdi-calendar', readonly='', v-on='on')
                        ...
                        v-col(cols='11', sm='5')
                            v-menu(ref='endtimemodal', v-model='endTimeModal', :close-on-content-click='false', :nudge-right='40', :return-value.sync='pickerEndTime', transition='scale-transition', offset-y='', max-width='290px', min-width='290px')
                                template(v-slot:activator='{ on }')
                                    v-text-field(v-model='pickerEndTime', label='End time', prepend-icon='mdi-clock', readonly='', v-on='on')
